...
namespace law::socket::can::isotp {
    ...
    using GenericOptionsRet = CustomError<GenericOptions>;
    ...
    using FlowControlFrameOptionsRet = CustomError<FlowControlFrameOptions>;
    ...
    using LinkLayerOptionsRet = CustomError<LinkLayerOptions>;
}
