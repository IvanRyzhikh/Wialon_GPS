...
namespace law::socket::net::tcp::detail {
    ...
    public:
        ...
        Status reconnect(std::chrono::milliseconds timeout) noexcept;
         ...
         * @return X_ETIMEDOUT
         */
        Status connect(std::chrono::milliseconds timeout) const noexcept;
        ...
        [[nodiscard]] SocketErrorRet getSocketError() const noexcept;
