...
namespace law::socket::net {
    ...
    public:
        ...
        InternetAddress(const sockaddr_in &nativeAddress) noexcept;
        ...
        InternetAddress &operator=(const sockaddr_in &rhs) noexcept;

        InternetAddress &operator=(sockaddr_in &&rhs) noexcept;
