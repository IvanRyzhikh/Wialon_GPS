...
namespace law::socket {
    enum class SocketOption {
        ...
        CANRAW_FILTER = CAN_RAW_FILTER,
        CANRAW_ERR_FILTER = CAN_RAW_ERR_FILTER,
        CANRAW_LOOPBACK = CAN_RAW_LOOPBACK,
        CANRAW_RECV_OWN_MSGS = CAN_RAW_RECV_OWN_MSGS,
        CANRAW_FD_FRAMES = CAN_RAW_FD_FRAMES,
        CANRAW_JOIN_FILTERS = CAN_RAW_JOIN_FILTERS,
#ifdef CANXL_MTU
        CANRAW_XL_FRAMES = CAN_RAW_XL_FRAMES,
        CANRAW_XL_VCID_OPTS = CAN_RAW_XL_VCID_OPTS,
#endif

        J1939_FILTER = SO_J1939_FILTER,
