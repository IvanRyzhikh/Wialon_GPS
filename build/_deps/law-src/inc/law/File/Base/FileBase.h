...
namespace law::file::detail {
    ...
    public:
        ...
        explicit FileBase(std::string_view filename, OpenOption options = ReadWrite(), OpenMode modes = OwnerReadWriteExec());

        /**
         * @return file permissions
         */
        [[nodiscard]] FileModesRet getPermissions() const noexcept;
         ...
         * */
        Status open(std::string_view filename, const OpenOption &options, const OpenMode &modes = OpenMode(0)) noexcept;
         ...
         * @return EPIPE
         * */
        WriteCountRet write(const void *buffer, std::size_t bufferSize) noexcept;
         ...
         * @return EC::X_EOVERFLOW
         * */
        [[nodiscard]] FileSizeRet getFileSize() const noexcept;
