...
//         return readOption(SocketOptionLevel::ISOTP, SocketOption::ISOTP_OPTS, &nativeOpts)
//                 .transform(
//                         [&nativeOpts] noexcept {
...
//         return readOption(SocketOptionLevel::ISOTP, SocketOption::ISOTP_RECV_OPTS, &nativeOpts)
//                 .transform(
//                         [&nativeOpts] noexcept {
...
//         return readOption(SocketOptionLevel::ISOTP, SocketOption::ISOTP_LL_OPTS, &nativeOpts)
//                 .transform(
//                         [&nativeOpts] noexcept {
